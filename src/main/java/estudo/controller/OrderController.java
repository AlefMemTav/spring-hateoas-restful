...
import estudo.assembler.OrderModelAssembler;
import estudo.exception.OrderNotFoundException;
...
public class OrderController {
	...
	public CollectionModel<EntityModel<CustomerOrder>> all() {
		...
		List<EntityModel<CustomerOrder>> orders = orderRepository.findAll().stream().map(assembler::toModel)
	...
	@PostMapping("/orders")
	public ResponseEntity<EntityModel<CustomerOrder>> newOrder(@RequestBody CustomerOrder order) {
